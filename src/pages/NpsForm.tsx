...
const FORM_STEPS: FormField[] = [
  { key: 'office', label: 'Por gentileza, qual é o seu escritório?', type: 'text', placeholder: 'Inserir texto', required: true },
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center p-6 relative overflow-hidden font-sans">
        ...
        <div className="text-center max-w-lg w-full relative z-10">
          ...
          <h1 className="text-4xl font-extrabold text-white mb-4 tracking-tight">Obrigado pela sua avaliação!</h1>
          <p className="text-slate-400 text-base leading-relaxed max-w-md mx-auto">
            Agradecemos por despender o seu bem mais precioso (seu tempo) para preencher esse formulário.
            <br />Seu resultado é o nosso compromisso 🍇
          </p>
        </div>
      </div>
    );
        ...
        <div className="flex-1 flex items-center justify-center p-6 relative z-10">
          <div className="max-w-xl w-full text-center">
            <div className="flex justify-center mb-6">
              <img src="/logobranca.png" alt="Grape Mídia" className="h-16 w-16 object-contain" />
            </div>

            <h1 className="text-4xl sm:text-5xl font-black text-white tracking-tight leading-tight max-w-xl mx-auto mb-6">
              Pesquisa de qualidade
            </h1>

            <p className="text-slate-400 text-sm sm:text-base max-w-md mx-auto mt-4 font-normal leading-relaxed text-left mb-4">
            ...
            <p className="text-slate-400 text-sm sm:text-base max-w-md mx-auto font-normal leading-relaxed text-left mb-8">
    ...
    <div className="min-h-screen bg-black flex flex-col relative overflow-hidden font-sans" onKeyDown={handleKeyDown}>
      ...
      <div className="flex items-center justify-between px-8 py-6 relative z-10">
        ...
        <div className="flex items-center gap-4">
          <img src="/logobranca.png" alt="Grape Mídia" className="h-6 w-6 object-contain" />
            ...
            {field.type === 'stars' ? (
              <div className="flex items-center gap-4 mt-4">
                {[1, 2, 3, 4, 5].map((star) => (
                  ...
                  >
                    <Star className={`w-10 h-10 ${value >= star ? 'fill-current' : ''}`} strokeWidth={value >= star ? 0 : 1.5} />
                  </button>
                ))}
              </div>
            ) : field.type === 'textarea' ? (
